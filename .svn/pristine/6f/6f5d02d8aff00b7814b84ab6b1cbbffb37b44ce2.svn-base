...
//		return jacksonUtil.toJson(list);
		...
		String sql = "select distinct vehi_no vehicle_no,comp_name company_name from vw_vehicle@db69 where 1=1";
		sql +=tj;
...
//		return jacksonUtil.toJson(list);
		...
		String sql = "select distinct comp_name company_name from vw_vehicle@db69 where 1=1";
		sql +=tj;
